...
import static com.megabyteful.infrastructure.api.fixture.ServiceProviderControllerTestFixture.*;
...
class ServiceProviderControllerTest {
  ...
  @MockBean private CreateServiceProvider createServiceProvider;
  @MockBean private GetServiceProvider getServiceProvider;
  @MockBean private UpdateServiceProvider updateServiceProvider;
  @MockBean private DeleteServiceProvider deleteServiceProvider;
  ...
  class CreateCustomerTests {
    ...
    void shouldCreateServiceProviderSuccessfully() throws Exception {
      ...
      mockMvc
          ...
          .andExpect(jsonPath("$.phone", equalTo("11949496536")))
          .andExpect(jsonPath("$.beautyServices", equalTo("Hair cut")))
          .andExpect(jsonPath("$.address", equalTo("Rua Hum, 500")))
          .andExpect(jsonPath("$.email", equalTo("maria.silva@gmail.com")));
