...
public class ServiceProviderController {
	...
	@PostMapping
	public ResponseEntity<ServiceProvider> create(@RequestBody @Valid ServiceProvider serviceProvider) {
	...
	@PutMapping("/{document}")
	public ResponseEntity<ServiceProvider> update(final @PathVariable String document, final @RequestBody @Valid UpdateServiceProviderRequest updateServiceProviderRequest) {
