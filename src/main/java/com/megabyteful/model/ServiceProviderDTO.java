...
public class ServiceProviderDTO {
	...
	public ServiceProviderDTO id(Long id) {
		this.id = id;
		return this;
	}
	 ...
	 * @param name
	 */
	public ServiceProviderDTO name(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @param document
	 */
	public ServiceProviderDTO document (String document) {
	 ...
	 * @param phone
	 */
	public ServiceProviderDTO phone (String phone) {
		this.phone = phone;
		return this;
	}
	 ...
	 */
	public ServiceProviderDTO beautyServices(String beautyServices) {
	 ...
	 * @param address
	 */
	public ServiceProviderDTO address(String address) {
	 ...
	 * @param email
	 */
	public ServiceProviderDTO email (String email) {
		this.email = email;
		return this;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ServiceProviderDTO other = (ServiceProviderDTO) obj;
	...
	public String toString() {
		return "ServiceProviderDTO [id=" + id + ", name=" + name + ", document=" + document + ", phone=" + phone
