...
public class CreateServiceProviderDTO {
	...
	public CreateServiceProviderDTO id(Long id) {
		this.id = id;
		return this;
	}
	 ...
	 * @param name
	 */
	public CreateServiceProviderDTO name(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @param document
	 */
	public CreateServiceProviderDTO document (String document) {
	 ...
	 * @param phone
	 */
	public CreateServiceProviderDTO phone (String phone) {
		this.phone = phone;
		return this;
	}
	 ...
	 */
	public CreateServiceProviderDTO beautyServices(String beautyServices) {
	 ...
	 * @param address
	 */
	public CreateServiceProviderDTO address(String address) {
	 ...
	 * @param email
	 */
	public CreateServiceProviderDTO email (String email) {
		this.email = email;
		return this;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CreateServiceProviderDTO other = (CreateServiceProviderDTO) obj;
	...
	public String toString() {
		return "CreateServiceProviderDTO [id=" + id + ", name=" + name + ", document=" + document + ", phone=" + phone
